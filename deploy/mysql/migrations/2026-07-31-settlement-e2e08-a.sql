...
-- 全部幂等：表/列/索引以 information_schema 判存；字典用 NOT EXISTS（该表无唯一键，IGNORE 无效）；
-- 菜单用 INSERT IGNORE 且显式指定 ID，撞主键即跳过。
-- ============================================================
...
-- ---------- 5. 字典 ----------
-- 幂等只能用 NOT EXISTS，不能用 INSERT IGNORE：这两张表除主键外**没有唯一键**，
-- IGNORE 无键可撞，等于普通 INSERT。而 init 与本迁移会灌同一批字典，
-- 「init 首启 + 逐个跑迁移」这条标准流程（验收 rebuild、灾备重建、新部署都走它）
-- 因此会把 1376~1381 各插两遍；api_dict_type 主表一旦重复，
-- ApiDictTypeServiceImpl.getByType 的 selectJoinOne 直接 TooManyResults 返回 500，
-- 且它带 @Cached 不缓存异常，每次调用都 500。2026-08-11 在一次性容器实测复现。

INSERT INTO `api_dict_type`(`DICT_NAME`,`DICT_TYPE`,`DICT_REMARK`)
SELECT '分账商品线','1376','分账比例配置的商品线维度' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_type` WHERE `DICT_TYPE`='1376');
INSERT INTO `api_dict_type`(`DICT_NAME`,`DICT_TYPE`,`DICT_REMARK`)
SELECT '分账收款方类型','1377','与 ws_split_record.RECEIVER_TYPE 同源' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_type` WHERE `DICT_TYPE`='1377');
INSERT INTO `api_dict_type`(`DICT_NAME`,`DICT_TYPE`,`DICT_REMARK`)
SELECT '收益流水类型','1378','机主收益钱包流水（独立于 1344 水卡钱包）' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_type` WHERE `DICT_TYPE`='1378');
INSERT INTO `api_dict_type`(`DICT_NAME`,`DICT_TYPE`,`DICT_REMARK`)
SELECT '对账差异分类','1379','日对账差错台账' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_type` WHERE `DICT_TYPE`='1379');
INSERT INTO `api_dict_type`(`DICT_NAME`,`DICT_TYPE`,`DICT_REMARK`)
SELECT '对账任务状态','1380','日对账批任务' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_type` WHERE `DICT_TYPE`='1380');
INSERT INTO `api_dict_type`(`DICT_NAME`,`DICT_TYPE`,`DICT_REMARK`)
SELECT '提现审核状态','1381','提现申请骨架（不做真实出金）' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_type` WHERE `DICT_TYPE`='1381');
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1375',4,4,'运营赠卡' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1375' AND `DICT_VALUE`=4);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1376',1,1,'售水' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1376' AND `DICT_VALUE`=1);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1376',2,2,'配送' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1376' AND `DICT_VALUE`=2);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1377',1,1,'机主' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1377' AND `DICT_VALUE`=1);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1377',2,2,'配送员' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1377' AND `DICT_VALUE`=2);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1377',3,3,'平台' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1377' AND `DICT_VALUE`=3);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1377',4,4,'渠道(预留)' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1377' AND `DICT_VALUE`=4);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1377',5,5,'推荐人(预留)' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1377' AND `DICT_VALUE`=5);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1377',6,6,'区域服务商(预留)' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1377' AND `DICT_VALUE`=6);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1378',1,1,'分润入账' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1378' AND `DICT_VALUE`=1);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1378',2,2,'分润回退(预留)' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1378' AND `DICT_VALUE`=2);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1378',3,3,'提现冻结' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1378' AND `DICT_VALUE`=3);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1378',4,4,'提现完成(预留)' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1378' AND `DICT_VALUE`=4);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1378',5,5,'提现驳回解冻' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1378' AND `DICT_VALUE`=5);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1379',1,1,'单边账' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1379' AND `DICT_VALUE`=1);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1379',2,2,'金额不符' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1379' AND `DICT_VALUE`=2);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1379',3,3,'状态不符' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1379' AND `DICT_VALUE`=3);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1379',4,4,'账本断裂' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1379' AND `DICT_VALUE`=4);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1380',1,1,'执行中' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1380' AND `DICT_VALUE`=1);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1380',2,2,'平账' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1380' AND `DICT_VALUE`=2);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1380',3,3,'有差异' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1380' AND `DICT_VALUE`=3);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1381',1,1,'待审核' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1381' AND `DICT_VALUE`=1);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1381',2,2,'审核通过(预留)' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1381' AND `DICT_VALUE`=2);
INSERT INTO `api_dict_data`(`DICT_CLASS`,`DICT_DEFAULT_FLAG`,`DICT_TYPE`,`DICT_SORT`,`DICT_VALUE`,`DICT_LABEL`)
SELECT NULL,1,'1381',3,3,'已驳回' FROM DUAL
 WHERE NOT EXISTS (SELECT 1 FROM `api_dict_data` WHERE `DICT_TYPE`='1381' AND `DICT_VALUE`=3);
