...
```html
<div class="m-4">Margin on all sides</div> <div class="m-8">Larger margin</div>
```
...
```html
<div class="mx-8">Horizontal margin</div> <div class="my-8">Vertical margin</div>
```
...
```html
<div class="-mt-8">Negative top margin</div> <div class="-mx-4">Negative horizontal margin</div>
```
...
```html
<div class="mx-auto">Centered horizontally</div> <div class="ml-auto">Pushed to right</div>
```
...
```html
<div class="m-[5px]">Custom margin</div> <div class="mx-[calc(50%-1rem)]">Custom calculation</div>
```
