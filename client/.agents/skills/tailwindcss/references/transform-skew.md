...
```html
<div class="skew-x-12">Skewed horizontally</div> <div class="skew-y-6">Skewed vertically</div>
```
...
```html
<div class="-skew-3">Negative skew</div> <div class="-skew-x-12">Negative x-axis skew</div>
```
