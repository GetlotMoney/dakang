...
```html
<div class="p-4">Padding on all sides</div> <div class="p-8">Larger padding</div>
```
...
```html
<div class="px-8">Horizontal padding</div> <div class="py-8">Vertical padding</div>
```
...
```html
<div class="p-[5px]">Custom padding</div> <div class="px-[calc(50%-1rem)]">Custom calculation</div>
```
