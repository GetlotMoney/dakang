...
<script setup lang="ts">
  ...
  import { resolveDisplayMenuActivePath } from '@/router/core/MenuDisplayProjector'
  ...
  const routerPath = computed(() =>
    resolveDisplayMenuActivePath(String(route.meta.activePath || route.path), props.list)
  )
